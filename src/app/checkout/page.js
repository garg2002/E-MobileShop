...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51OFCQgSJyZWb4i48zuplAKFR2j14WDW0ZyqgTmJKP2A5kamcoYTlLqVezS84rQUbXuVbYIVuJpRHj6dC6SCWMwnd00W3gt4GpM"  
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            {addresses && addresses.length ? (
              addresses.map((item) => (
                ...
                >
                  ...
                  <button className="mt-5 mr-5 inline-block bg-yellow-500 hover:bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide">
          ...
          <button
            ...
            className="mt-5 mr-5 inline-block bg-blue-900 hover:bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
          >
            Add new address
          </button>
